...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleTransactionNotEditableException(TransactionNotEditableException ex) {
        log.error("Transaction not editable: {}", ex.getMessage());
        return ResponseEntity
